...
|| Campo | Valor |
|-------|-------|
| **ID interno** | provedor/xiaomi-mimo |
| **Nome legal / marca** | Xiaomi MiMo (Xiaomi Corporation) |
| **URL** | https://platform.xiaomimimo.com/ |
| **URL de pricing** | https://platform.xiaomimimo.com/docs/en-US/pricing |
| **URL de documentação/API** | https://platform.xiaomimimo.com/docs/en-US/model-intro/mimo-v2.5-pro-ultraspeed |
| **Sede** | China, Pequim |
| **Tipo** | Cloud |
...
| **Contato comercial/institucional** | Desconhecido (verificar) |
| **Termos de uso relevantes** | Desconhecido (verificar) |
| **Política de uso de dados** | Desconhecido (verificar) — provedor chinês, implicações de soberania de dados |
| **Status do provedor** | Ativo |
| **Notas** | Plataforma em expansão agressiva. Modelo MiMo-V2.5-Pro-UltraSpeed atingiu 1000+ tokens/s em modelo de 1T parâmetros (com TileRT). Pesos abertos (MIT) disponíveis no Hugging Face. Token Plan disponível em 4 tiers (Lite ¥39/mês, Standard, Pro, Max). API compatível com OpenAI e Anthropic. |
| **Última atualização** | 2026-06-08 |
| **Última verificação** | 2026-06-08 |
| **Próxima verificação** | 2026-06-23 (15 dias — UltraSpeed beta trial em andamento, monitorar) |
...
- 2026-06-08: Ficha criada com dados do lançamento UltraSpeed e Token Plans